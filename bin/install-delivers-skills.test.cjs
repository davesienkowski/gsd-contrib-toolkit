 ...
 *     sandbox gsd-core checkout, proving the 2 skills land ALONGSIDE the 5 commands + 13 hooks via the
...
// skills land ALONGSIDE the 5 commands + 13 hooks via the SAME composed LIVE engine, and runRemove
...
test(
  'end-to-end: runInstall delivers the 2 skills (alongside the 5 commands + 13 hooks) + runRemove reclaims the skill links',
  { skip: E2E_SKIP },
  () => {
    ...
    try {
      ...
      // Co-existence proof: the 2 skills land ALONGSIDE the 13 marker-tagged hooks + the 5 commands.
      ...
      assert.strictEqual(taggedHooks, 13, 'the 2 skills must land ALONGSIDE the 13 marker-tagged hooks (full local-parity install)');
