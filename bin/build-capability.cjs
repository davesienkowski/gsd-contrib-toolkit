 ...
 * (`capabilities/contrib-gate/hooks/`) is a GENERATED ARTIFACT — never a hand-maintained second
 ...
 *   - Every generated write is CONFINED under capabilities/contrib-gate/hooks/ — any resolved
...
const BUNDLE_DIR = path.join(REPO_ROOT, 'capabilities', 'contrib-gate');
