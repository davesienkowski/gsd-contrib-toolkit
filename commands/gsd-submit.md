---
description: File a verified finding as a proper open-gsd/gsd-core issue + fix PR, following the core-contribution skill's gated pipeline exactly.
argument-hint: <finding / bug description, or an audit item like "M-7">
allowed-tools: Skill, Bash, Read, Edit, Write, Grep, Glob
---

**BEFORE ANYTHING ELSE: invoke the Skill tool with `skill: "core-contribution"` now.**
